...
COPY --from=builder /go/src/github.com/newrelic/nri-elasticsearch/elasticsearch-definition.yml /var/db/newrelic-infra/newrelic-integrations/elasticsearch-definition.yml
